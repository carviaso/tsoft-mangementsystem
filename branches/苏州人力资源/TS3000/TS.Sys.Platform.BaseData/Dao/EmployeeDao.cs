...
namespace TS.Sys.Platform.BaseData.Dao
{
    ...
    {
        private static string SQL_ALL_LIST = "select emp.cGUID,emp.cCode,emp.cName,case iSex when 1 then '男' else '女' end as iSex,dept.cName cDepartment from CM_Employee emp left join CM_Department dept on emp.cDepartment = dept.cCode";
