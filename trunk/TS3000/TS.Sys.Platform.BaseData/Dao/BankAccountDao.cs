...
namespace TS.Sys.Platform.BaseData.Dao
{
    public class BankAccountDao:BaseDao
    {
        ...
        public DataTable QueryAcctByParent(Object cCode)
        {
            ...
            String sql = "select bankAcct.cGUID,bankAcct.cCode,bankAcct.cName,bankAcct.cBankAcct,bankAcct.cTimeStamp,bank.cName cBank from  CM_BankAccount bankAcct inner join CM_Bank bank on bankAcct.cBank =bank.cCode " + cCode;
