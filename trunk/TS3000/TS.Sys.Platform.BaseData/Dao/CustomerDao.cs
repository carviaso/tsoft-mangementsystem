...
namespace TS.Sys.Platform.BaseData.Dao
{
    public class CustomerDao:BaseDao
    {
        ...
        private static string SQL_LIST = "select cust.cGUID,cust.cCode,cust.cName,rg.cName cRegion,cust.cTimeStamp from CM_Customer cust left join CM_Region rg on cust.cRegion = rg.cCode ";
